...
----It is used for providing access to another object.

1. How would you explain form validation to someone who has never programmed before?

----form validation checks to see if the info provided by the user is correct. It's helpful to let the user know what kind of info the page is looking for (especially through alerts).

1. In 1-2 sentences, define end to end testing.

----it's a technique that tests the entire software/code from beginning to end to ensure it works as expected. I does not test just a piece of the software or a piece of the code.
